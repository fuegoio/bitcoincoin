<template>
  <v-row class="fill-height ma-0">
    <v-col lg="6" md="4" class="hidden-sm-and-down login-left" />
    <v-col lg="6" md="8" sm="12" class="login elevation-10">
        ...
        <v-col xl="8" lg="10" md="12">
          ...
          <v-row justify="space-between" align="center" class="mt-4 px-1">
            ...
            <v-col class="text-right" sm="6" cols="12">
              <a class="primary--text font-weight-bold" @click="register"
